...
def test_euclidian_recall():
    np.random.seed(10)
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'euclidean', 1) > .1
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'euclidean', 2) > .2
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'euclidean', 4) > .35
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'euclidean', 8) > .55

def test_angular_recall():
    np.random.seed(10)
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'angular', 1) > .09
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'angular', 2) > .18
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'angular', 4) > .27
    assert _test_recall_inner(10**2, 20, 10, 2, 10, 'angular', 8) > .36
...
def _test_recall_inner(n, d, nq, dpb, at, metric, n_probes):
    ...
    else: trus = np.broadcast_to(np.arange(n), (nq, n))
...
def test_small():
    np.random.seed(10)
    assert _test_recall_inner(4, 20, 10, 2, 10, 'euclidean', 1) > .1
